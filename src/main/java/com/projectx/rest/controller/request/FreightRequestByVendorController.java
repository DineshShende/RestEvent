...
public class FreightRequestByVendorController {
	...
	public FreightRequestByVendor newRequest(@RequestBody FreightRequestByVendor freightRequestByCustomer)
	{
		FreightRequestByVendor savedEntity=freightRequestByVendorService.newRequest(freightRequestByCustomer);
	...
	{
		FreightRequestByVendor savedEntity=freightRequestByVendorService.getRequestById(requestId);
		
		return savedEntity;
	}
	
	@RequestMapping(value="/findByVendorId/{vendorId}")
	public List<FreightRequestByVendor> getAllRequestForVendor(@PathVariable Long vendorId)
	{
		List<FreightRequestByVendor> savedEntity=freightRequestByVendorService.getAllRequestForVendor(vendorId);
	...
	{
		Boolean result=freightRequestByVendorService.deleteRequestById(requestId);
