...
public interface DocumentDetailsService {
	...
	public DocumentDetails updateDocument(DocumentKey key,byte[] document,String contentType,Integer requestedBy,Long requestedById) 
	...
	public DocumentDetails updateVerificationStatusAndRemark(DocumentKey key,Integer verificationStatus,
			String verificationRemark,Integer requestedBy,Long requestedById)throws DocumentDetailsNotFoundException;
