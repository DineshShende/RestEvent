...
public class QuickRegisterDataFixture {
	...
	public static QuickRegisterEntity standardEmailMobileCustomer()
	{
		return new QuickRegisterEntity(CUST_ID,CUST_FIRSTNAME,CUST_LASTNAME,CUST_EMAIL,CUST_MOBILE,CUST_PIN_CODE,CUST_IS_EMAIL_VERIFIED_FALSE,
				CUST_IS_MOBILE_VERIFIED_FALSE,ENTITY_TYPE_CUSTOMER,CUST_INSERT_TIME,CUST_UPDATE_TIME,CUST_UPDATED_BY,CUST_UPDATED_BY,CUST_ID,CUST_ID);
	...
	public static QuickRegisterEntity standardEmailMobileCustomerWithError()
	{
		return new QuickRegisterEntity(CUST_ID,CUST_FIRSTNAME,CUST_LASTNAME,null,null,CUST_PIN_CODE,CUST_IS_EMAIL_VERIFIED_FALSE,
				CUST_IS_MOBILE_VERIFIED_FALSE,ENTITY_TYPE_CUSTOMER,CUST_INSERT_TIME,CUST_UPDATE_TIME
	...
	public static QuickRegisterEntity standardEmailMobileVendor()
	{
		return new QuickRegisterEntity(CUST_ID,CUST_FIRSTNAME,CUST_LASTNAME,VENDOR_EMAIL,VENDOR_MOBILE,CUST_PIN_CODE,CUST_IS_EMAIL_VERIFIED_FALSE,
				CUST_IS_MOBILE_VERIFIED_FALSE,ENTITY_TYPE_VENDOR,CUST_INSERT_TIME,CUST_UPDATE_TIME
				,CUST_UPDATED_BY,CUST_UPDATED_BY,CUST_ID,CUST_ID);
	...
	{
		return new CustomerQuickRegisterEntityDTO(CUST_FIRSTNAME,CUST_LASTNAME,CUST_EMAIL,null,CUST_PIN_CODE,ENTITY_TYPE_CUSTOMER,CUST_UPDATED_BY,CUST_ID);
	}
	
	public static CustomerQuickRegisterEntityDTO standardMobileCustomerDTO()
	{
		return new CustomerQuickRegisterEntityDTO(CUST_FIRSTNAME,CUST_LASTNAME,null,CUST_MOBILE,CUST_PIN_CODE,ENTITY_TYPE_CUSTOMER,CUST_UPDATED_BY,CUST_ID);
	}
	
	public static CustomerQuickRegisterEntityDTO standardEmailMobileCustomerDTO()
	{
		return new CustomerQuickRegisterEntityDTO(CUST_FIRSTNAME,CUST_LASTNAME,CUST_EMAIL,CUST_MOBILE,CUST_PIN_CODE,ENTITY_TYPE_CUSTOMER,CUST_UPDATED_BY,CUST_ID);
	}
	...
	{
		return new QuickRegisterEntity(null, CUST_FIRSTNAME, CUST_LASTNAME, CUST_EMAIL, CUST_MOBILE, CUST_PIN_CODE, CUST_IS_EMAIL_VERIFIED_FALSE,
				CUST_IS_MOBILE_VERIFIED_FALSE,ENTITY_TYPE_CUSTOMER, new Date(), new Date()
		,CUST_UPDATED_BY,CUST_UPDATED_BY,CUST_ID,CUST_ID);
	}
	
	public static QuickRegisterEntity standardMobileCustomerAfterStatusPopulation()
	{
		return new QuickRegisterEntity(null, CUST_FIRSTNAME, CUST_LASTNAME, null, CUST_MOBILE, CUST_PIN_CODE, 
				null, CUST_IS_MOBILE_VERIFIED_FALSE,ENTITY_TYPE_CUSTOMER, new Date(), new Date(),CUST_UPDATED_BY,CUST_UPDATED_BY,CUST_ID,CUST_ID);
	}
	
	public static QuickRegisterEntity standardEmailCustomerAfterStatusPopulation()
	{
		return new QuickRegisterEntity(null, CUST_FIRSTNAME, CUST_LASTNAME, CUST_EMAIL, null, CUST_PIN_CODE,
				CUST_IS_EMAIL_VERIFIED_FALSE, null,ENTITY_TYPE_CUSTOMER, new Date(), new Date(),CUST_UPDATED_BY,CUST_UPDATED_BY,CUST_ID,CUST_ID);
		
	}
	
	public static QuickRegisterEntity standardEmailMobileCustomerAfterInitialization()
	{
		return new QuickRegisterEntity(null, CUST_FIRSTNAME, CUST_LASTNAME, CUST_EMAIL, CUST_MOBILE, CUST_PIN_CODE,
				CUST_IS_EMAIL_VERIFIED_FALSE, CUST_IS_MOBILE_VERIFIED_FALSE,ENTITY_TYPE_CUSTOMER, CUST_INSERT_TIME,
				CUST_UPDATE_TIME,CUST_UPDATED_BY,CUST_UPDATED_BY,CUST_ID,CUST_ID);
	}
	
	public static QuickRegisterEntity standardMobileCustomerAfterInitialization()
	{
		return new QuickRegisterEntity(null, CUST_FIRSTNAME, CUST_LASTNAME, null, CUST_MOBILE, CUST_PIN_CODE,
				null, CUST_IS_MOBILE_VERIFIED_FALSE,ENTITY_TYPE_CUSTOMER, CUST_INSERT_TIME, CUST_UPDATE_TIME
				,CUST_UPDATED_BY,CUST_UPDATED_BY,CUST_ID,CUST_ID);
	}
	...
	{
		return new QuickRegisterEntity(null, CUST_FIRSTNAME, CUST_LASTNAME, CUST_EMAIL, null, CUST_PIN_CODE,
				CUST_IS_EMAIL_VERIFIED_FALSE,null,ENTITY_TYPE_CUSTOMER, CUST_INSERT_TIME, CUST_UPDATE_TIME
				,CUST_UPDATED_BY,CUST_UPDATED_BY,CUST_ID,CUST_ID);
	...
	{
		return new QuickRegisterEntity(CUST_ID, CUST_FIRSTNAME, CUST_LASTNAME, CUST_EMAIL, CUST_MOBILE, 
				CUST_PIN_CODE, CUST_IS_EMAIL_VERIFIED_FALSE, CUST_IS_MOBILE_VERIFIED_FALSE,ENTITY_TYPE_CUSTOMER, 
				CUST_INSERT_TIME, CUST_UPDATE_TIME,CUST_UPDATED_BY,CUST_UPDATED_BY,CUST_ID,CUST_ID);
	}
	
	public static QuickRegisterEntity standardMobileCustomerAfterSaving()
	{
		return new QuickRegisterEntity(CUST_ID, CUST_FIRSTNAME, CUST_LASTNAME, null, CUST_MOBILE, CUST_PIN_CODE,
				null, CUST_IS_MOBILE_VERIFIED_FALSE,ENTITY_TYPE_CUSTOMER, CUST_INSERT_TIME, CUST_UPDATE_TIME
				,CUST_UPDATED_BY,CUST_UPDATED_BY,CUST_ID,CUST_ID);
	}
	...
	{
		return new QuickRegisterEntity(CUST_ID, CUST_FIRSTNAME, CUST_LASTNAME, CUST_EMAIL, null, CUST_PIN_CODE,
				CUST_IS_EMAIL_VERIFIED_FALSE, null,ENTITY_TYPE_CUSTOMER, CUST_INSERT_TIME, CUST_UPDATE_TIME
				,CUST_UPDATED_BY,CUST_UPDATED_BY,CUST_ID,CUST_ID);
	...
	{
		return new UpdateEmailMobileVerificationStatus(CUST_ID, CUST_IS_EMAIL_VERIFIED_TRUE,new Date(),CUST_UPDATED_BY,CUST_ID);
	}
	
	
	public static com.projectx.mvc.domain.quickregister.UpdateEmailHashDTO standardUpdateEmailHashDTOMVC()
	{
		return new com.projectx.mvc.domain.quickregister.UpdateEmailHashDTO(CUST_ID,ENTITY_TYPE_CUSTOMER, ENTITY_TYPE_CUSTOMER,
				CUST_UPDATED_BY,CUST_ID);
	}
	...
	{
		return gson.toJson(new ResetPasswordRedirectDTO(CUST_EMAIL,CUST_UPDATED_BY,CUST_ID));
	}
}
