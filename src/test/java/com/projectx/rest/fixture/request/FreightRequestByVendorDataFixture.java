...
public class FreightRequestByVendorDataFixture {
	...
	{
		return new FreightRequestByVendor(REQ_VEHICLE, REQ_SOURCE, REQ_DESTINATION, REQ_DRIVER, REQ_AVAIL_DATE, REQ_AVAIL_TIME,
	...
	{
		return new FreightRequestByVendor(REQ_VEHICLE, REQ_SOURCE, REQ_DESTINATION_UPDATED, REQ_DRIVER, REQ_AVAIL_DATE, REQ_AVAIL_TIME_UPDATED,
